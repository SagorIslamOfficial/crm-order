...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment.method' => ['nullable', 'in:cash,bkash,nagad,bank'],
            'payment.amount' => ['required_if:payment.method,cash,bkash,nagad,bank', 'nullable', 'numeric', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'payment.required' => 'Payment information is optional.',
            'payment.method.required' => 'Payment method must be selected when providing payment.',
            'payment.amount.required_if' => 'Payment amount is required when payment method is selected.',
